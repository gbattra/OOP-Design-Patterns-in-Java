...
public enum BirdClassification {
  ...
  PARROT(
          ...
          "to mimic sounds. Many pet parrots can learn a vocabulary of up to 100 words and often" +
          "adopt a single \"favorite\" saying.  They include the rose-ring parakeet, gray parrot," +
          "and sulfur-crested cockatoo."),
  PIGEON(
          "Pigeon",
          "Pigeons (or doves) are known for feeding their young \"bird milk\" very similar to the" +
          "milk of mammals. Found all over the world, there are several varieties that are" +
          "extinct."),
  SHOREBIRD(
          "Shorebird",
  ...
  WATERFOWL(
          "Waterfowl",
          "Waterfowl are another classification that live near water sources (fresh or salt) and" +
          "include ducks, swans, and geese.");
