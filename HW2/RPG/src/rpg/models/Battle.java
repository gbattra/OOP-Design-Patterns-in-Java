...
/**
 * A class representing a battle between multiple players. A battle has IPlayer's and a list
 * of IGear instances. When it is time to fight, a call to dressPlayers() will dress each player
 * with the gear that gives them each the best chance to win. A call to fight() returns the most
 * powerful player as the victor.
 */
