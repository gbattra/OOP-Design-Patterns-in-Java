...
public class BattleTest {
  ...
  public void setup() {
    this.battleTwoPlayer = new Battle(
            ...
            new ArrayList<>())
            .addGear(GearType.HELMET, 0, 10, "steel", "helmet")
            .addGear(GearType.HELMET, 0, 5, "weak", "helmet")
            .addGear(GearType.HELMET, 0, 7, "kevlar", "hat")
            .addGear(GearType.SWORD, 15, 5, "steel", "sword")
            .addGear(GearType.SHIELD, 5, 15, "steel", "shield")
            .addGear(GearType.GLOVE, 2, 5, "kevlar", "gloves")
            .addGear(GearType.SHIELD, 0, 5, "soft", "shield")
            .addGear(GearType.SHIELD, 5, 10, "light", "shield")
            .addGear(GearType.SNEAKER, 3, 5, "light-up", "sneaker")
            .addGear(GearType.BOOT, 5, 5, "steel-toed", "boot");
