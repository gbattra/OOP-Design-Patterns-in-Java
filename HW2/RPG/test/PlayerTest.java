...
public class PlayerTest {
  ...
  @Before
  public void setup() {
    this.footGear1 = new Gear(GearType.BOOT, 10, 10, "strong", "boot");
    this.footGear2 = new Gear(GearType.BOOT, 1, 1, "weak", "boot");
    this.combinedFootGear = new Gear(
            GearType.BOOT,
    ...
    this.headGear1 = new Gear(GearType.HAT, 0, 10, "strong", "hat");
    this.headGear2 = new Gear(GearType.HAT, 0, 1, "weak", "hat");
    this.combinedHeadGear = new Gear(
            GearType.HAT,
            this.headGear1.getAttack() + this.headGear2.getAttack(),
