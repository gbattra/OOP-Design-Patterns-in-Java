...
public class ExploreDemo {
  ...
  public static void main(String[] args) {
    System.out.print("----------------------------------------------------\n");
    System.out.print("This demo EXPLORES the entire maze.\n");
    System.out.print("----------------------------------------------------\n");
    ...
    System.out.print("Exploring the entire maze...\n");
    Path path = perfectMaze.exploreTo(perfectMaze.getGoal().getCoordinates());
