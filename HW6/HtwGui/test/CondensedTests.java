...
import htw.HtwPlayer;
import htw.IHtwGame;
import htw.IHtwPlayer;
import htw.CustomConfigCommand;
import htw.DirActionStrategy;
import htw.ICommand;
import htw.IdActionStrategy;
import htw.MoveCommand;
import htw.NewConfigCommand;
import htw.ShootCommand;
import htw.StandardConfigCommand;
import htw.StartGameCommand;
import htw.Cave;
import htw.DeadEnd;
import htw.IHtwMaze;
import htw.IHtwNode;
import htw.StandardStrategy;
import htw.TunnelStrategy;
import htw.HtwConfiguration;
...
import maze.Edge;
import maze.GoldRoomNode;
import maze.ICoordinates;
import maze.IEdge;
import maze.IPath;
import maze.Node;
import maze.Path;
import maze.ThiefRoomNode;
import maze.IConfiguration;
import maze.IConfigurationBuilder;
import maze.MazeConfigurationBuilder;
import maze.IMazePlayer;
