 ...
 * 
 * @param <T> the element in this node
 */
public interface GenericListADTNode<T> {
   ...
   * @return the node representing the list after the node was removed
   */
  ...
  /**
   * Given this node, advance the iteration by one step by returning the advance
   * node in the list. If there is no advance, return itself.
   * 
   ...
   * 
   * @return true if there is something in this list ahead, false otherwise
   */
  boolean canAdvance();
